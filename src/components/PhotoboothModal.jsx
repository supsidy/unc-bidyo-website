...
const DRIVE_URL = "https://drive.google.com"; // TODO: replace with the actual UNC BIDYO Drive folder link
      ...
      >
        ...
        <div className="relative flex h-40 items-center justify-center overflow-hidden bg-bidyo-crimson">
          ...
          <button
            ...
            className="absolute right-4 top-4 grid h-8 w-8 place-items-center rounded-full bg-white/90 text-base text-bidyo-crimson shadow transition hover:bg-white"
          >
            ✕
          </button>
          ...
          <img
            ...
            alt=""
            aria-hidden="true"
            className="relative z-10 h-44 w-44 -mb-8 object-contain drop-shadow-xl"
          />
        </div>
