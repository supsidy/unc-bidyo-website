...
export default function BookingForm() {
    ...
    try {
      await emailjs.send(
        ...
        TEMPLATE_ID,
        {
          ...
          event_start_date: form.startDate,
          event_end_date: form.isMultiDay ? form.endDate : form.startDate,
          event_start_time: form.startTime,
  ...
  return (
    <div
      className={`fixed inset-0 z-[100] flex items-center justify-center overflow-y-auto px-4 py-8 backdrop-blur-sm transition-opacity duration-300 ease-out ${
        visible ? "bg-black/70 opacity-100" : "bg-black/70 opacity-0"
      }`}
    ...
    >
      <div
        ...
        className={`relative w-full max-w-2xl overflow-hidden rounded-[2rem] bg-white shadow-2xl transition-all duration-300 ease-out ${
          visible
