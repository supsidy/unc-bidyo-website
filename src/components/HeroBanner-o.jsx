...
export default function HeroBanner_VariationB() {
  return (
    <section
      className="relative flex min-h-screen items-center overflow-hidden bg-gradient-to-br from-bidyo-crimsonBlack via-bidyo-crimsonDeep to-bidyo-crimsonBlack px-8 pb-16 pt-28 lg:px-16 lg:py-0 xl:px-24"
    >
      ...
      <div className="relative mx-auto grid w-full max-w-[1440px] grid-cols-1 items-center gap-12 lg:grid-cols-12 xl:gap-16">
        ...
        <div className="flex flex-col items-start gap-6 lg:col-span-6">
          ...
          <h1 className="font-display text-5xl font-extrabold leading-[1.05] tracking-tight text-bidyo-crimson lg:text-6xl xl:text-7xl">
            UNCean.
          </h1>
