    ...
    <section className="relative flex min-h-screen items-center overflow-hidden bg-gradient-to-br from-bidyo-crimsonBlack via-bidyo-crimsonDeep to-bidyo-crimsonBlack px-8 pb-16 pt-28 lg:px-16 lg:py-0 xl:px-24">
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-[1440px] grid-cols-1 items-center gap-12 lg:grid-cols-12 xl:gap-16">
        ...
        <div className="flex flex-col items-start gap-6 lg:col-span-6 mt-12 lg:mt-24">
          <h1
            className="font-display text-5xl font-extrabold leading-[1.05] tracking-tight text-white opacity-0 lg:text-5xl xl:text-6.5xl"
            style={{ animation: "heroFadeInUp 800ms ease-out 100ms forwards" }}
          >
            Capturing the moments of every
          </h1>
          <h1
            className="font-display text-5xl font-extrabold leading-[1.05] tracking-tight text-bidyo-crimson opacity-0 lg:text-6xl xl:text-7xl"
            style={{
              WebkitTextStroke: "1.5px white",
              animation: "heroFadeInUp 800ms ease-out 300ms forwards",
            }}
          >
            UNCean.
          </h1>
          ...
          <p
            className="max-w-lg text-lg leading-relaxed text-white/75 opacity-0 xl:text-lg"
            style={{ animation: "heroFadeInUp 800ms ease-out 500ms forwards" }}
          >
          ...
          <div
            ...
            style={{ animation: "heroFadeInUp 800ms ease-out 700ms forwards" }}
          >
            <button
              type="button"
              onClick={openBooking}
